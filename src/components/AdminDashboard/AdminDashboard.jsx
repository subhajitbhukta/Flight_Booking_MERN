...
function AdminDashboard() {
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      try {
        const response = await axios.get('https://flight-backend-hc4f.onrender.com/api/bookings', { withCredentials: true });
  ...
  const handleLogout = async () => {
    try {
      await axios.get('https://flight-backend-hc4f.onrender.com/api/auth/logout', { withCredentials: true });
  ...
  const confirmDelete = async () => {
    if (bookingToDelete) {
      try {
        await axios.delete(`https://flight-backend-hc4f.onrender.com/api/bookings/${bookingToDelete}`, { withCredentials: true });
